          ...
          <header className="sticky top-0 z-30 flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3.5 shadow-sm sm:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center gap-2 rounded-lg bg-emerald-600 px-4 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-emerald-700 disabled:opacity-60 sm:text-sm"
              >
                ↻ Refresh Data
              </button>
